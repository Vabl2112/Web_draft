      ...
      <div className="flex w-full flex-col justify-between px-6 py-8 lg:w-1/2 lg:px-16">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="grid gap-3">
            <Button variant="outline" className="h-12 w-full gap-3 text-base">
        ...
        <div className="relative flex h-full flex-col items-center justify-center p-16 text-background">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="mt-1 text-sm text-background/70">Мастеров</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-amber-500">10k+</div>
              <div className="mt-1 text-sm text-background/70">Работ</div>
            </div>
            <div className="text-center">
