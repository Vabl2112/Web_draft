...
export async function GET() {
  ...
  const products = [
    ...
    },
    {
      ...
      description: "Премиум подарок для настоящих ценителей. Можно использовать на любые услуги студии.",
      price: 10000,
      originalPrice: null,
    ...
    {
      id: "10",
      title: "Худи EGG Studio Limited",
      description: "Лимитированная коллекция. Утепленное худи с уникальным принтом.",
      price: 4500,
      originalPrice: 5500,
    ...
    {
      id: "11",
      title: "Набор игл для тату",
      description: "Профессиональный набор игл разных конфигураций. 50 штук в стерильной упаковке.",
      price: 3200,
      originalPrice: null,
    ...
    {
      id: "12",
      title: "Лабрет с опалом",
      description: "Элегантное украшение для губы с натуральным опалом. Титан ASTM F136.",
      price: 2800,
      originalPrice: 3200,
